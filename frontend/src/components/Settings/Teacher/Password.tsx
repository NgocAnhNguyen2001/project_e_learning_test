...
import { useChangeTeacherPasswordMutation, useUpdateUserOnboardedMutation } from "schema/generated/graphql";
...
const PasswordSettings = (): React.ReactElement => {
  const [updatePassword] = useChangeTeacherPasswordMutation();
