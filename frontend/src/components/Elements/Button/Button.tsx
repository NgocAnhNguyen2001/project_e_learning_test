...
const variants = {
  ...
  gray: "bg-gray-500 text-white border-b-gray-600",
  purple: "bg-[#7513B3] border-[#4F00B1] text-white",
  transparent: "bg-[#FFFFFF]/25 border-none text-white ",
};
  ...
  (
    ...
    return (
      <button
        ...
        type={type}
        className={clsx(
          `flex items-center disabled:opacity-70 hover:scale-105 focus:scale-100 ${
            props.disabled
              ? ""
              : "active:translate-y-0.5 active:border-b-transparent"
          } transition duration-200 ease-in-out rounded-xl disabled:cursor-not-allowed font-medium focus:outline-none border-b-4`,
          variants[variant],
          sizes[size],
      ...
      >
        ...
        <span
          className={clsx(
            "mt-1 font-bold w-full flex justify-center",
            uppercase ? "uppercase" : "",
          )}
        >
          {props.children}
