...
export const RadioCardGroup = <T extends string>(props: RadioCardGroupProps<T>): React.ReactElement => {
...
export const RadioCard = (props: RadioCardProps): React.ReactElement => {
